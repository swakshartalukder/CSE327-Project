...
<div class= "form">
  <form style="margin-left: 50px;" action="" method="get">
    ...
    <input type="number" name="emid" value="<?php echo "$ed" ?>" size="25" placeholder="" required>
    <br>
    <label> Absent </label>
...
if($_GET['edit'])
{
	...
	if($data)
	{
		...
		?>
		<META HTTP-EQUIV = "Refresh" CONTENT = "0; URL = http://www.empmansys.com/CSE327-Project/payment.php">
		<?php
	}
	else
	{
